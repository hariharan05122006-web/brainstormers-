...
-- 3. Workers Table (With Location & Email)
...
-- 4. Complaints Table (With GIS & Lifecycle)
create table if not exists complaints (
    ...
    location_lat double precision, -- Captured from Map
...
-- 5. Complaint Images Table (Evidence)
